...
/**
 * El perfil de datos permite restringir los datos que surgen desde la base de datos en base a una dimensi�n dada (carrera, sexo, dependencia, etc.)
 * El m�todo filtrar analiza una consulta SQL dada, identificando las tablas que se relacionan con las dimensiones definidas en el proyecto y
 * agregando clausulas WHERE necesarias para filtrar las mismas. Por ejemplo si es una consulta SQL de personas, tenemos una dimensi�n sexo y el usuario actual tiene definido
 * un perfil de datos por el valor Masculino, agregar� sexo='M' a las clausulas de la consulta.
 *
...
class toba_perfil_datos
{
	...
	*/
	...
	/**
	* Retorna las restricciones aplicadas sobre una dimensi�n espec�fica
	...
	*/
	...
	/**
	* Retorna las restricciones aplicadas sobre una dimensi�n espec�fica agrupadas por perfil de datos
	* @param string $nombre Nombre de la dimension
	* @return array Arreglo de restricciones si aplica, sino null
	 */
