...
class toba_ap_tabla_db_s extends toba_ap_tabla_db
{
	...
	{
		if (isset($this->_columnas[$col]) && isset($this->_columnas[$col]['tipo']) && $this->_columnas[$col]['tipo'] === 'F') {
			return "TO_CHAR(" . $this->_alias  . "." . $col . ", 'YYYY-MM-DD') $col";
		}
		if (isset($this->_columnas[$col]) && isset($this->_columnas[$col]['tipo']) && $this->_columnas[$col]['tipo'] === 'T') {
			return "TO_CHAR(" . $this->_alias  . "." . $col . ", 'YYYY-MM-DD HH24:MI:SS') $col";
		}	
	...
	{
		return $this->agregar_schema($this->_tabla)  . ' '. $this->_alias;
	}
}
?>