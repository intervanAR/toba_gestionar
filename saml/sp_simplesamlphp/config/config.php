...
$config = array (
	 ...
	 * reverse proxy).
	 */
	'baseurlpath'           => $ini['sp_'.$proyecto]['baseurlpath'],
	'certdir'               => 'cert/',
	'loggingdir'            => 'log/',
	'datadir'               => 'data/',
	 ...
	 */
	'auth.adminpassword'		=> (isset($ini['sp_'.$proyecto]['adminpassword'])?$ini['sp_'.$proyecto]['adminpassword']:uniqid()),
	 ...
	 */
	'secretsalt' => (isset($ini['sp_'.$proyecto]['secretsalt'])?$ini['sp_'.$proyecto]['adminpassword']:'5mt9bbx152mfqsg3mqt18ozzk33556hhfwykcu4w'),
	 ...
	 */
	'technicalcontact_name'     => $ini['sp_'.$proyecto]['technicalcontact_name'],
	'technicalcontact_email'    => $ini['sp_'.$proyecto]['technicalcontact_email'],
	 ...
	 */
	'session.phpsession.cookiename'  => $ini['sp_'.$proyecto]['session.phpsession.cookiename'],
