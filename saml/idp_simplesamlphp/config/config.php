...
$config = array (
	 ...
	 * reverse proxy).
	 */
	'baseurlpath'           => $ini['idp']['baseurlpath'],
	'certdir'               => 'cert/',
	'loggingdir'            => 'log/',
	'datadir'               => 'data/',
	 ...
	 */
	'auth.adminpassword'		=> (isset($ini['idp']['adminpassword'])?$ini['idp']['adminpassword']:uniqid()),
	 ...
	 */
	'secretsalt' => (isset($ini['idp']['secretsalt'])?$ini['idp']['adminpassword']:'5mt9bbx152mfqsg3mqt18ozzkwykcu4w'),
	 ...
	 */
	'technicalcontact_name'     => $ini['idp']['technicalcontact_name'],
	'technicalcontact_email'    => $ini['idp']['technicalcontact_email'],
